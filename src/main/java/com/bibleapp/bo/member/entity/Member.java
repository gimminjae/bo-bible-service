package com.bibleapp.bo.member.entity;


import com.bibleapp.bo.member.dto.MemberDto;
import com.bibleapp.bo.member.dto.MemberType;
import com.bibleapp.bo.member.dto.Role;
...
import static com.bibleapp.bo.common.generator.IdGenerator.ENTITY_TYPE;
...
public class Member {
    ...
    @GenericGenerator(
            name = "memId",
            strategy = "com.bibleapp.bo.common.generator.IdGenerator",
            parameters = {
